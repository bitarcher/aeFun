...
public class WindElasticTree2 extends WindElasticCompositeMeshes {
    ...
    public WindElasticTree2(float pX, float pY, float pWidth, float pHeight, VertexBufferObjectManager vertexBufferObjectManager, float windStrength, EnumSide windSide, Color rootColor, Color leavesColorA, Color leavesColorABorder, Color leavesColorB) {
