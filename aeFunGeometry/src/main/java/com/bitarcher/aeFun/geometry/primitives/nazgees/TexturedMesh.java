package com.bitarcher.aeFun.geometry.primitives.nazgees;
...
public class TexturedMesh extends Shape {
	...
	/**
	 * Uses a default {@link HighPerformanceTexturedMeshVertexBufferObject} in {@link org.andengine.opengl.vbo.DrawType#STATIC} with the {@link org.andengine.opengl.vbo.attribute.VertexBufferObjectAttribute}s: {@link Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	/**
	 * Uses a default {@link HighPerformanceTexturedMeshVertexBufferObject} with the {@link org.andengine.opengl.vbo.attribute.VertexBufferObjectAttribute}s: {@link Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
